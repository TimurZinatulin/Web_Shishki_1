    ...
    <div id="app1">
        ...
        <div id="projects" style="left: -10px;">
            <div id="content">
                ...
                <button href="" class="link" class="btn btn-primary btn__first" 
                    data-toggle="collapse"
                    data-target=".collapse"
                    data-text="Collapse" style="position: absolute; border: none; top: 650px; left: 685px;">ПОКАЗАТЬ ЕЩЁ</button>
            </div>
        </div>
    </div>
